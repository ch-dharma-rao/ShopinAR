package com.dharma.shopinar.usersession;
...
import com.dharma.shopinar.LoginActivity;
...
public class UserSession {
    ...
    public static String phone = "000000";
    public static String photo = "https://rb.gy/1wqt6w";
     ...
     * */
    public void createLoginSession(String userID, String name, String email, String mobile, String photo){
        ...
        editor.putString(KEY_PROFILE, photo);
    ...
    public void setKeyProfile(String photo){
        editor.putString(KEY_PROFILE, photo);
    }
